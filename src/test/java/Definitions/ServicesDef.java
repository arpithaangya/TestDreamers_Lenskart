...
public void asserting_the_feature() {
	Assert.assertEquals(ServicesLoc.Samepage.getText(),"Buy The Best Eyewear From Lenskart");
	 base.log.info("Assert for search");
